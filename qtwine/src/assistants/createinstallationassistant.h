 ...
 ***************************************************************************/
#ifndef CREATEINSTALLATIONASSISTANT_H
#define CREATEINSTALLATIONASSISTANT_H
 ...
 */
class CreateInstallationAssistant : public QWizard
{
public:
	enum Pages { StartPage, ChoicePage, BasicInformationPage, AdvancedInformationPage, FinishPage };

	CreateInstallationAssistant(QWidget *parent = 0);
	int nextId() const;
